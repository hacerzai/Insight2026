...
function SciencePlatformContent(){
  ...
  return <section className={`science-platform ${exhibition?"exhibition":""}`} id="science-lab">
    ...
    <header className="lab-hero"><div><p>CBSE · NCERT · CLASSES 1–12</p><h2>Learn by doing,<br/><em>not memorising.</em></h2><span>Choose your class, open a subject and move through guided concepts, interactive practice and mastery checks—plus live computer-vision science labs.</span><div className="hero-actions"><a href="#courses">CHOOSE YOUR CLASS</a><button onClick={openRobot}>BEAT THE ROBOT ↓</button></div></div><div className="hero-orbit" aria-hidden="true"><i/><i/><i/><b>AI</b><span>LEARN</span><span>PRACTICE</span><span>MASTER</span></div></header>
    <CourseExplorer/>
